...
class LakefsBlock(Block):
    ...
    Example:
        Load a stored value:
        ```python
        from prefect_lakefs import LakefsBlock
        block = LakefsBlock.load("BLOCK_NAME")
        ```
    """
    ...
    _documentation_url = "https://arthur_dent.github.io/prefect-lakefs/blocks/#prefect-lakefs.blocks.LakefsBlock"  # noqa
