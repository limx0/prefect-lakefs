...
import prefect_lakefs

COLLECTION_SLUG = "prefect_lakefs"
...
for _, module_name, ispkg in iter_modules(prefect_lakefs.__path__):
...
with mkdocs_gen_files.open(examples_catalog_path, "w") as generated_file:
    generated_file.write(
        dedent(
            ...
            Below is a list of examples for `prefect-lakefs`.
            """
        )
    )
